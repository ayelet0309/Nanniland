...
export default function InstagramFinalCTA() {
  return (
    ...
    >
      ...
      <div
        style={{
          position: "relative", padding: "8px 26px 44px", textAlign: "center",
        }}
      >
        <h2
          style={{
            ...
            fontSize: "42px", lineHeight: 1.08, color: "#FFFDF9",
          }}
        >
        ...
        <p
          style={{
            margin: "0 auto 28px", fontSize: "16.5px", lineHeight: 1.6,
            color: "#DDE3D2", maxWidth: "32ch",
          }}
        >
        ...
        >
          ...
          <span
            dir="ltr"
            style={{ fontSize: "14.5px", fontWeight: 700, color: "#EFF2E9" }}
          >
            WhatsApp · nanniland
          </span>
        </div>
