...
const ROWS = [
  ...
  { label: "מינימום הזמנה", value: "5 שעות ביום", valueColor: "#5F6B50", valueFontSize: "14.5px", valueFontWeight: 800 },
  { label: "יום עבודה ארוך", value: "8 שעות", valueColor: "#5F6B50", valueFontSize: "14.5px", valueFontWeight: 800 },
...
export default function InstagramPricing() {
  return (
    ...
    >
      ...
      <div
        style={{
          textAlign: "center", background: "#5F6B50",
          borderRadius: "26px", padding: "30px 22px",
          boxShadow: "0 16px 32px rgba(95,107,80,.3)", marginBottom: "14px",
        }}
      >
        ...
        <div
          style={{
            fontFamily: "'Frank Ruhl Libre', serif", fontWeight: 600,
        ...
        <div style={{ fontSize: "13.5px", color: "#C7D1B8", marginTop: "8px" }}>
          בהתאם לנני שתתאים לכם
        </div>
      </div>
      ...
      <div
        style={{
          background: "#FFFDF9", borderRadius: "22px",
          padding: "6px 20px", boxShadow: "0 10px 24px rgba(95,75,45,.07)",
        }}
      >
        {ROWS.map((row, i) => (
          <div
          ...
          >
            <span style={{ fontSize: "14.5px", fontWeight: 700, color: "#33302A" }}>
              {row.label}
            </span>
            <span
              style={{
